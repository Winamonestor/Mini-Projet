...
p.ajouterEmploye(new Vendeur("Kalvounandi", "Samuel", 45, "1995", 30000));
p.ajouterEmploye(new Representant("Djoda", "Nyowe", 25, "1998", 20000));
p.ajouterEmploye(new Technicien("Gangdebe", "Eli", 28, "2000", 1000));
p.ajouterEmploye(new Manutentionnaire("Hinsou", "Emmanuel", 32, "2003", 45));
p.ajouterEmploye(new TechnARisque("Winamo", "Nestor", 28, "1998", 1000));
p.ajouterEmploye(new ManutARisque("Ben", "Nesta", 30, "1998", 45));
p.afficherSalaires();
